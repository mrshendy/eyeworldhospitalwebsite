...
@section('content')
 <div class="container">
    ...
    <div class="card">
        <form method="post" action="{{route('Admin.books.update', $data->id)}}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              ...
              @endforeach
               ...
               <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                   ...
                   <input type="number" class="form-control"  name="count" id="count" value="{{ isset($data) ? $data->count : old('count') }}" required>
                </div>

                 <div class="form-group col-6">
                    <label for="author_id">{{__('price')}}</label>
                   <input type="number" class="form-control" name="price" id="price" value="{{ isset($data) ? $data->price : old('price') }}" required>
                </div>


                 <div class="form-group col-6">
                    <label for="author_id">{{__('pdf price')}}</label>
                   <input type="number" class="form-control" name="pdf_price" id="pdf_price" value="{{ isset($data) ? $data->pdf_price : old('pdf_price') }}" required>
                </div>
            </div>
