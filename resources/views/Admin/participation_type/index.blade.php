...
<div class="container">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-3">
            <a href="{{route('Admin.participation_types.create')}}" class="btn " style="background-color: #267B26 ; color:white"> {{__('system.add')}}</a>
          </div>
        </div>
...
<x-delete-modal>
  <x-slot:route>
      {{route('Admin.participation_types.destroy',0)}}
  </x-slot>
  @method('DELETE')
